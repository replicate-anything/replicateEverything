...
Package-backed studies export `run_replication()`, `get_code()`, and related helpers from the study package itself. Validate with `check_package_replication()`, then `prepare_study_for_registry()` for handoff files under `inst/registry/`.
