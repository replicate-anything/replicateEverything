...
See `vignette("package-replication-checklist")` for layout and `add_paper()`.
...
| Run whole paper | `replicate_paper()` |
...
| Package study workflow | `check_package_replication()`, `add_paper()` |
