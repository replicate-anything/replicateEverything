...
After checks pass, copy the generated registry stub into the [registry repository](https://github.com/replicate-anything/registry) (`studies/<folder>.yml` and a row in `index.csv` with `handle`, `doi`, `title`, etc.).
