...
| `check_and_bake_study(".")` | Validate package study |
...
A quick **manual smoke check** first — from the package source directory,
`"local"` resolves to the working-directory study without any registry
setup:
