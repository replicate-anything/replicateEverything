test_that("get_code emits R figure usage tip with yaml-implied call", {
  with_fixture_opts({
    ...
    expect_true(grepl("1\\. Prefer run_replication", tip))
    expect_true(grepl("\\(simplest\\)", tip))
