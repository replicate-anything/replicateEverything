...
- Exported maintainer API: \[check_study_compatibility()\],
  \[install_study_dependencies()\], \[install_registry_dependencies()\],
  and \[maintainer_dependency_hint()\]. See
  [`vignette("maintainer-setup")`](https://replicate-anything.github.io/replicateEverything/articles/maintainer-setup.md).
  Live Run checks dependencies first and stops with setup hints when
